  ...
  RequestApi.fetch("/user/id", {
    ...
    .then((res) => {
      if (res.success) {
        ...
        document.getElementById("userState").checked =
          res.result.state == "0" ? false : true;
        document.getElementById("userUserRoleId").value =
          res.result.user_role_id;
